...
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME" , "╼⃝𖠁 ʀɪsʜᴜꭙ 𝐌ᴜsɪᴄ 𖠁⃝╾")
# ---------------------------------------------------------
ASSUSERNAME = getenv("ASSUSERNAME" , "╼⃝𖠁 ʀɪsʜᴜ ꭙ 𝐌ᴜsɪᴄ 𖠁⃝╾")
...
SOURCE = getenv("SOURCE", "https://github.com/Rishubot")
